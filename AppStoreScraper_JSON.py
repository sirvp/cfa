...
existing_files = sorted(glob.glob("Reviews/UtilityCompany_AppStore_Reviews_*days.json"))
if existing_files:
...
with open(json_file, "w", encoding="utf-8") as file:
    json.dump(all_reviews, file, ensure_ascii=False, indent=2)

print(f"Reviews saved to {json_file} ({len(all_reviews)} reviews)")
